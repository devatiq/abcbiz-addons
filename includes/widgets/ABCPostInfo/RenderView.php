...
<div class="abcbiz-ele-post-info-area">
    ...
    <span class="abcbiz-ele-comment-link"><a href="<?php comments_link(); ?>"> <i class="eicon-instagram-comments"></i> <?php comments_number(esc_html__( 'Leave a comment', 'abcbiz-addons' ), esc_html__( '1 Comment', 'abcbiz-addons' ), esc_html__( '% Comments', 'abcbiz-addons' )); ?></a></span><?php endif; ?>
