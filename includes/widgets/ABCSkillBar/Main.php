<?php
namespace Includes\Widgets\ABCSkillBar;
...
class Main extends BaseWidget
{
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Skill Settings', 'abcbiz-multi'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Enable Tooltip', 'abcbiz-multi'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Show Value on Right?', 'abcbiz-multi'),
                'description' => esc_html__('Show percentage value on right side.', 'abcbiz-multi'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'abcbiz-multi'),
                'label_off' => esc_html__('No', 'abcbiz-multi'),
                'return_value' => 'yes',
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default' => esc_html__('Skill Heading', 'abcbiz-multi'),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__('Progress Color', 'abcbiz-multi'),
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__('Tooltip BG Color', 'abcbiz-multi'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__('Tooltip Text Color', 'abcbiz-multi'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'abc_skills_bar_list',
            [
                'label' => esc_html__('Skill Bar', 'abcbiz-multi'),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'abcbiz_elementor_skill_bar_text' => esc_html__('Title #1', 'abcbiz-multi'),
                        'abcbiz_elementor_skill_bar_value' => esc_html__('80', 'abcbiz-multi'),
                    ],
                    [
                        'abcbiz_elementor_skill_bar_text' => esc_html__('Title #2', 'abcbiz-multi'),
                        'abcbiz_elementor_skill_bar_value' => esc_html__('75', 'abcbiz-multi'),
                    ],
                ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Skill Style', 'abcbiz-multi'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Bar Height', 'abcbiz-multi'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'em'],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Empty Prograss Color', 'abcbiz-multi'),
                'type' => Controls_Manager::COLOR,
                'default' => '#f5f5f5',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Tooltip', 'abcbiz-multi'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'abcbiz_elementor_skill_bar_tooltip_switch' => 'yes',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Offset Top', 'abcbiz-multi'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Offset Right', 'abcbiz-multi'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
