...
<div class="abcbiz-elementor-social-share-area">
    ...
    <ul>
        ...
        ?>
        <li><a href="http://pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>&media=<?php echo esc_url($thumbnail_url); ?>" title="<?php esc_html_e('Share on Pinterest', 'abcbiz-addons'); ?>" target=_blank><svg clip-rule="evenodd" fill-rule="evenodd" height="512" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg" xmlns:xodm="http://www.corel.com/coreldraw/odm/2003" id="fi_4423405"><g id="Layer_x0020_1"><path d="m220.57 338.64c-13.44 70.48-29.86 138.06-78.5 173.36-15.01-106.54 22.05-186.55 39.25-271.49-29.34-49.4 3.53-148.8 65.42-124.3 76.15 30.12-65.94 183.63 29.45 202.8 99.6 20.01 140.25-172.81 78.5-235.51-89.24-90.55-259.76-2.07-238.79 127.57 5.1 31.69 37.85 41.31 13.09 85.04-57.12-12.66-74.16-57.7-71.97-117.75 3.53-98.3 88.32-167.12 173.37-176.64 107.55-12.04 208.49 39.48 222.43 140.66 15.7 114.19-48.55 237.86-163.55 228.97-31.18-2.42-44.26-17.87-68.7-32.71z" fill-rule="nonzero"></path></g></svg></a></li>

        <li><a href="http://www.linkedin.com/shareArticle?mini=true&amp;title=<?php echo esc_attr($abcelsocialtitle); ?>&amp;url=<?php the_permalink(); ?>" title="<?php esc_html_e('Share on LinkedIn', 'abcbiz-addons'); ?>" target=_blank><svg id="fi_3128219" enable-background="new 0 0 100 100" height="512" viewBox="0 0 100 100" width="512" xmlns="http://www.w3.org/2000/svg"><g id="_x31_0.Linkedin"><path d="m90 90v-29.3c0-14.4-3.1-25.4-19.9-25.4-8.1 0-13.5 4.4-15.7 8.6h-.2v-7.3h-15.9v53.4h16.6v-26.5c0-7 1.3-13.7 9.9-13.7 8.5 0 8.6 7.9 8.6 14.1v26h16.6z"></path><path d="m11.3 36.6h16.6v53.4h-16.6z"></path><path d="m19.6 10c-5.3 0-9.6 4.3-9.6 9.6s4.3 9.7 9.6 9.7 9.6-4.4 9.6-9.7-4.3-9.6-9.6-9.6z"></path></g></svg></a></li>

        <li><a href="http://www.reddit.com/submit?url=<?php the_permalink(); ?>&amp;title=<?php echo esc_attr($abcelsocialtitle); ?>" title="<?php esc_html_e('Share on Reddit', 'abcbiz-addons'); ?>" target=_blank><svg id="fi_2111634" enable-background="new 0 0 24 24" height="512" viewBox="0 0 24 24" width="512" xmlns="http://www.w3.org/2000/svg"><path d="m21.325 9.308c-.758 0-1.425.319-1.916.816-1.805-1.268-4.239-2.084-6.936-2.171l1.401-6.406 4.461 1.016c0 1.108.89 2.013 1.982 2.013 1.113 0 2.008-.929 2.008-2.038s-.889-2.038-2.007-2.038c-.779 0-1.451.477-1.786 1.129l-4.927-1.108c-.248-.067-.491.113-.557.365l-1.538 7.062c-2.676.113-5.084.928-6.895 2.197-.491-.518-1.184-.837-1.942-.837-2.812 0-3.733 3.829-1.158 5.138-.091.405-.132.837-.132 1.268 0 4.301 4.775 7.786 10.638 7.786 5.888 0 10.663-3.485 10.663-7.786 0-.431-.045-.883-.156-1.289 2.523-1.314 1.594-5.115-1.203-5.117zm-15.724 5.41c0-1.129.89-2.038 2.008-2.038 1.092 0 1.983.903 1.983 2.038 0 1.109-.89 2.013-1.983 2.013-1.113.005-2.008-.904-2.008-2.013zm10.839 4.798c-1.841 1.868-7.036 1.868-8.878 0-.203-.18-.203-.498 0-.703.177-.18.491-.18.668 0 1.406 1.463 6.07 1.488 7.537 0 .177-.18.491-.18.668 0 .207.206.207.524.005.703zm-.041-2.781c-1.092 0-1.982-.903-1.982-2.011 0-1.129.89-2.038 1.982-2.038 1.113 0 2.008.903 2.008 2.038-.005 1.103-.895 2.011-2.008 2.011z"></path></svg></a></li>
    </ul>
