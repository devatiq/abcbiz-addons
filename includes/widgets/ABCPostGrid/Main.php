<?php 
namespace ABCBiz\Includes\Widgets\ABCPostGrid;
...
class Main extends BaseWidget {
		...
		protected $name = 'abcbiz-post-grid';
		protected $title = 'ABC Post Grid';		
		protected $icon = 'eicon-post-grid abcbiz-addons-icon';
