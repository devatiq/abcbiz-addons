...
<div class="abcbiz-elementor-wp-menu-area">
    ...
    if (!empty($abcbiz_selected_menu_slug)) {
        ...
        echo sprintf(
            '<li>%s</li>',
            esc_html__('Menu not selected or found.', 'abcbiz-addons')
        );     
    }
    ?>
...
<div class="abcbiz-mob-menu-icon-wrap">
 <div class="abcbiz-responsive-menu"><svg ViewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" id="fi_4543046"><g id="Layer_13" data-name="Layer 13"><path d="m30 7a1 1 0 0 1 -1 1h-26a1 1 0 0 1 0-2h26a1 1 0 0 1 1 1zm-5 8h-22a1 1 0 0 0 0 2h22a1 1 0 0 0 0-2zm-9 9h-13a1 1 0 0 0 0 2h13a1 1 0 0 0 0-2z"></path></g></svg></div>
   <div class="abcbiz-mobilemenu">
    <?php
    if (!empty($abcbiz_selected_menu_slug)) {
        wp_nav_menu(array(
            'menu' => $abcbiz_selected_menu_slug,
