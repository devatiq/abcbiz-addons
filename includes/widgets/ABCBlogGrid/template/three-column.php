...
<div class="abcbiz-ele-three-column-blog-area">
    <div class="abcbiz-ele-three-column-blog"><!-- start abcbiz-ele-three-column-blog -->
        <?php
                ...
                <div class="abcbiz-ele-blog-item">
                    ...
                    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                        ...
                        <div class="abcbiz-ele-blog-meta">
                            ...
                            <?php if ($abcbiz_comment_switch === 'yes') : ?><span class="comment-link"><a href="<?php comments_link(); ?>"><i class="eicon-instagram-comments"></i> <?php comments_number(esc_html__('Leave a comment', 'abcbiz-addons'), esc_html__('1 Comment', 'abcbiz-addons'), esc_html__('% Comments', 'abcbiz-addons')); ?></a></span><?php endif; ?>
                        </div>
