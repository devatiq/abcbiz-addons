...
<!-- Card Info Area-->
<div class="abcbiz-card-style-two-area">
    <div class="abcbiz-card-info-wrap">

    <!-- Dynamic Image -->
    <?php if (!empty($abcbiz_settings['abcbiz_elementor_card_info_image_two']['url'])): ?>
        <figure class="abcbiz-card-image">
            <img fetchpriority="high" src="<?php echo esc_url($abcbiz_settings['abcbiz_elementor_card_info_image_two']['url']); ?>" alt="<?php echo esc_attr($abcbiz_heading_text); ?>">
