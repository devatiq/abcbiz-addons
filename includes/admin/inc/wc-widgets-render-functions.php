...
function abcbiz_wc_product_bread_crumb_field_render() {
    ...
    <div class="abcbiz-widget-lists">
        <div class="abcbiz-widget-image-overlay">
            <a href="https://abcplugin.com/widgets/woocommerce-breadcrumb-elementor-widgets/" target="_blank">
        ...
        <h3><?php echo esc_html__("Product Bread Crumb", "abcbiz-multi"); ?></h3>
...
function abcbiz_wc_product_tabs_field_render() {
    ...
    <div class="abcbiz-widget-lists">
        <div class="abcbiz-widget-image-overlay">
            <a href="https://abcplugin.com/widgets/woocommerce-product-tabs-elementor-widgets/" target="_blank">
        ...
        <h3><?php echo esc_html__("Product Tabs", "abcbiz-multi"); ?></h3>
        <label class="abcbiz-switch">
...
function abcbiz_wc_product_short_desc_field_render() {
    ...
    <div class="abcbiz-widget-lists">
        <div class="abcbiz-widget-image-overlay">
            <a href="https://abcplugin.com/widgets/woocommerce-product-short-description-elementor-widget/" target="_blank">
        ...
        <h3><?php echo esc_html__("Product Short Description", "abcbiz-multi"); ?></h3>
        <label class="abcbiz-switch">
...
function abcbiz_wc_product_related_field_render() {
    ...
    <div class="abcbiz-widget-lists">
        <div class="abcbiz-widget-image-overlay">
            <a href="https://abcplugin.com/widgets/woocommerce-related-product-elementor-widgets/" target="_blank">
        ...
        <h3><?php echo esc_html__("Related Product", "abcbiz-multi"); ?></h3>
        <label class="abcbiz-switch">
...
function abcbiz_wc_product_price_field_render() {
    ...
    <div class="abcbiz-widget-lists">
        <div class="abcbiz-widget-image-overlay">
            <a href="https://abcplugin.com/widgets/woocommerce-product-pricing-elementor-widget/" target="_blank">
        ...
        <h3><?php echo esc_html__("Product Price", "abcbiz-multi"); ?></h3>
        <label class="abcbiz-switch">
...
function abcbiz_wc_product_meta_field_render() {
    ...
    <div class="abcbiz-widget-lists">
        <div class="abcbiz-widget-image-overlay">
            <a href="https://abcplugin.com/widgets/woocommerce-product-meta-elementor-widgets/" target="_blank">
        ...
        <h3><?php echo esc_html__("Product Meta", "abcbiz-multi"); ?></h3>
        <label class="abcbiz-switch">
...
function abcbiz_wc_product_img_field_render() {
    ...
    <div class="abcbiz-widget-lists">
        <div class="abcbiz-widget-image-overlay">
            <a href="https://abcplugin.com/widgets/woocommerce-product-image-elementor-widget/" target="_blank">
        ...
        <h3><?php echo esc_html__("Product Image", "abcbiz-multi"); ?></h3>
        <label class="abcbiz-switch">
...
function abcbiz_wc_checkout_page_field_render() {
    ...
    <div class="abcbiz-widget-lists">
        <div class="abcbiz-widget-image-overlay">
            <a href="https://abcplugin.com/widgets/woocommerce-custom-checkout-page-elementor-widget/" target="_blank">
        ...
        <h3><?php echo esc_html__("Checkout Page", "abcbiz-multi"); ?></h3>
        <label class="abcbiz-switch">
...
function abcbiz_wc_cart_page_field_render() {
    ...
    <div class="abcbiz-widget-lists">
        <div class="abcbiz-widget-image-overlay">
            <a href="https://abcplugin.com/widgets/woocommerce-custom-cart-page-elementor-widget/" target="_blank">
        ...
        <h3><?php echo esc_html__("Cart Page", "abcbiz-multi"); ?></h3>
        <label class="abcbiz-switch">
...
function abcbiz_wc_add_to_cart_icon_field_render() {
    ...
    <div class="abcbiz-widget-lists">
        <div class="abcbiz-widget-image-overlay">
            <a href="https://abcplugin.com/widgets/woocommerce-add-to-cart-elementor-widgets/" target="_blank">
        ...
        <h3><?php echo esc_html__("Add to cart", "abcbiz-multi"); ?></h3>
        <label class="abcbiz-switch">
