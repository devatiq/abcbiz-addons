...
add_settings_field(
    ...
    esc_html__('Product Bread Crumb', 'abcbiz-multi'),
...
add_settings_field(
    ...
    esc_html__('Product Tabs', 'abcbiz-multi'),
...
add_settings_field(
    ...
    esc_html__('Product Short Description', 'abcbiz-multi'),
...
add_settings_field(
    ...
    esc_html__('Related Product', 'abcbiz-multi'),
...
add_settings_field(
    ...
    esc_html__('Product Price', 'abcbiz-multi'),
...
add_settings_field(
    ...
    esc_html__('Product Meta', 'abcbiz-multi'),
...
add_settings_field(
    ...
    esc_html__('Product Image', 'abcbiz-multi'),
...
add_settings_field(
    ...
    esc_html__('Checkout Page', 'abcbiz-multi'),
...
add_settings_field(
    ...
    esc_html__('Cart Page', 'abcbiz-multi'),
...
add_settings_field(
    ...
    esc_html__('Add to cart', 'abcbiz-multi'),
