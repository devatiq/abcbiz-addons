...
if ( class_exists( 'WooCommerce' ) && function_exists( 'wc_get_product' ) && 1 == get_option('abcbiz_wc_product_tabs_field')) {
    ...
    function abcbiz_wc_product_meta_box_html($post) {
        ...
        echo '<p><strong>' . esc_html__('Note:', 'abcbiz-addons') . '</strong> ' . esc_html__('This area is specifically for ABCBiz Addons and Templates for Elementor by ABCPlugin Products description tab contents.', 'abcbiz-addons') . '</p>';
