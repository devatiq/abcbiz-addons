...
<div class="abc-ele-three-column-blog-area">
    <div class="abc-ele-three-column-blog"><!-- start abc-ele-three-column-blog -->
        <?php
        ...
        if ($query->have_posts()) :
                ...
                <div class="abc-ele-blog-item">
                    ...
                    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                        ...
                        <?php if ($abc_excerpt_switch === 'yes') : ?>
                            ...
                            $abc_limited_excerpt = wp_trim_words($abc_excerpt_content, 25);
            ...
            endwhile; ?>
    </div> <!-- end abc-ele-three-column-blog -->
