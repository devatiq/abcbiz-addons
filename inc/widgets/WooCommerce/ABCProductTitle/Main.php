<?php 
namespace inc\widgets\WooCommerce\ABCProductTitle;
...
class Main extends BaseWidget {
		...
		protected $name = 'abc-product-title';
		protected $title = 'ABC Product Title';
		protected $icon = 'eicon-product-title';
	...
	protected function register_controls() {
		...
		//Heading tag
        $this->add_control(
            'abc_elementor_product_title_tag',
            [
		...
		$this->add_responsive_control(
			'abc_elementor_product_title_align',
			[
				'label' => esc_html__( 'Alignment', 'ABCMAFTH'),
				...
				'selectors' => [
					'{{WRAPPER}} .abc-elementor-product-title-area' => 'text-align: {{VALUE}}',
				],
			]
		);
        ...
        $this->start_controls_section(
            'abc_elementor_product_title_style',
            [
		...
		$this->add_control(
			'abc_elementor_product_title_color',
			[
				'label' => esc_html__( 'Color', 'ABCMAFTH' ),
				'type'  => Controls_Manager::COLOR,
				'default' => '#ffffff',
				'selectors' => [
					'{{WRAPPER}} .abc-product-title-tag' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'abc_elementor_product_title_typography',
				'label' => esc_html__( 'Typography', 'ABCMAFTH' ),
				'selector' => '{{WRAPPER}} .abc-product-title-tag',
			]
		);
